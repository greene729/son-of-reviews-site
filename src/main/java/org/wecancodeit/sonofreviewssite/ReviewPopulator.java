...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Review reviewKid1 = new Review("Lizzy",
				...
				"Recomendation: BREAK HER SPIRIT. She must know she is not special.", "3/10", "lizzy.jpg", category3);
		Review reviewKid2 = new Review("Ashley",
				...
				"Recomendation: Give her more attention Greg!", "10/5", "ashley.jpg", category3);
		Review reviewKid3 = new Review("Corbin",
				...
				"Recomendation: Tell me the truth GREG!", "Pending", "corbin.jpg", category3);
		...
		Review hobby1 = new Review("Wood Working",
				...
				"Recomendation: Get back into it. I think you show some real potential. You just need practice", "7/10",
				"wood.jpg", category4);
		Review hobby2 = new Review("Upholstery",
				...
				"Recomendation: I would sit in any of these chairs with zero arm twisting", "10/10", "upholstery.jpg",
				category4);
		Review hobby3 = new Review("Collecting Shot Glasses",
				...
				"Recomendation: You're an idiot and I treasure you", "8/10", "shots.jpg", category4);
		...
		Review lifeChoice2 = new Review("Jobs",
				...
				"Recomendation: Get a job that gets me more free stuff.", "7.5/10", "", category2);
		// house
		Review lifeChoice3 = new Review("House",
				...
				"Recomendation: Let Carol Go wild", "9/10", "", category2);
		...
		Review lifeChoice4 = new Review("Degree: English",
				...
				"Recomendation: You should have listened to your dad.", "2/10", "", category2);
		...
		Review dadJoke1 = new Review("Joke about a pepper.",
				...
				"Recomendation: Needs some work. Would be greatly depricated by being worked on.", "6/10",
		...
		Review dadJoke2 = new Review("A surprisingly honest aphorism",
				...
				"Recomendation: Engrave this on a statue of Greg.", "20/10", "dad-joke-2.jpg", category5);
		...
		Review dadJoke3 = new Review("Joke about an overweight gourd",
				...
				"Recomendation; Don't quit your day job", "4/10", "dad-joke-3.jpg", category5);
