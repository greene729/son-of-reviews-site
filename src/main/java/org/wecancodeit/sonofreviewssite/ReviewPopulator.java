...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Review hobby2 = new Review("Upholstery",
				...
				"I would sit in any of these chairs with zero arm twisting", "10/10", "upholstery.jpg", category4);
		Review hobby3 = new Review("Collecting Shot Glasses",
				...
				"You're an idiot and I treasure you", "8/10", "shot-glasses.jpg", category4);
